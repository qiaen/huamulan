    ...
    <section class="report">
        ...
        <el-table v-loading="xoading" class="zm-table" @selection-change="mainSelectionChange" height="100%" :data="mainTable" border>
			...
			<el-table-column label="是否启用" align="center">
				<template #default="scope">
					<el-switch v-model="scope.row.isDisable" :active-value="0" :inactive-value="1" active-color="#13ce66" inactive-color="#ff4949">
					</el-switch>
				</template>
			</el-table-column>
...
export default {
    ...
    setup() {
        ...
        function showSelected() {
            let s = Mx.mainSelected.value.map((item: any) => item.id)
